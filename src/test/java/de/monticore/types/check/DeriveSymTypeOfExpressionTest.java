...
public class DeriveSymTypeOfExpressionTest {
    ...
    public void setupForEach() {
        ...
        OOTypeSymbol genSuperType = TypeSymbolsMill.oOTypeSymbolBuilder()
                ...
                .setName("GenSuper")
                .build();
        OOTypeSymbolSurrogate loader = new OOTypeSymbolSurrogate("GenArg");
        loader.setEnclosingScope(scope);
        SymTypeExpression genArg = SymTypeExpressionFactory.createTypeVariable(loader);
        loader = new OOTypeSymbolSurrogate("GenSuper");
        loader.setEnclosingScope(scope);
        SymTypeExpression genSuper = SymTypeExpressionFactory.createGenerics(loader, genArg);
        OOTypeSymbol genSubType = TypeSymbolsMill.oOTypeSymbolBuilder()
                ...
                .setEnclosingScope(scope)
                .build();
        loader = new OOTypeSymbolSurrogate("GenSub");
        loader.setEnclosingScope(scope);
        SymTypeExpression genSub = SymTypeExpressionFactory.createGenerics(loader, genArg);
    ...
    public void deriveTFromASTNameExpression3() throws IOException {
        ...
        ASTExpression astex = p.parse_StringExpression(s).get();
        astex.accept(flatExpressionScopeSetter);
        assertEquals("Person", printType(tc.typeOf(astex)));
    }
    ...
    public void deriveTFromASTNameExpression4() throws IOException {
        ...
        ASTExpression astex = p.parse_StringExpression(s).get();
        astex.accept(flatExpressionScopeSetter);
        assertEquals("Student", printType(tc.typeOf(astex)));
    }
    ...
    public void deriveTFromASTNameExpression5() throws IOException {
        ...
        ASTExpression astex = p.parse_StringExpression(s).get();
        astex.accept(flatExpressionScopeSetter);
        assertEquals("FirstSemesterStudent", printType(tc.typeOf(astex)));
    }
    ...
    public void deriveTFromLiteralString() throws IOException {
        ...
        astex.accept(flatExpressionScopeSetter);
        assertEquals("String", printType(tc.typeOf(astex)));
    }
    ...
    public void genericsTest() throws IOException {
        ...
        astex.accept(flatExpressionScopeSetter);
        assertEquals("GenSuper<GenArg>", printType(tc.typeOf(astex)));
    }
