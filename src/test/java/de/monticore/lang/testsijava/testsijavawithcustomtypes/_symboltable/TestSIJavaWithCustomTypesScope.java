...
public class TestSIJavaWithCustomTypesScope extends TestSIJavaWithCustomTypesScopeTOP {

  public TestSIJavaWithCustomTypesScope() {
    super();
  }

  public TestSIJavaWithCustomTypesScope(boolean isShadowingScope) {
    super(isShadowingScope);
  }

  public TestSIJavaWithCustomTypesScope(ITestSIJavaWithCustomTypesScope enclosingScope) {
    this(enclosingScope, false);
  }

  public TestSIJavaWithCustomTypesScope(ITestSIJavaWithCustomTypesScope enclosingScope, boolean isShadowingScope) {
  ...
  @Override
  public List<OOTypeSymbol> resolveTypeLocallyMany(boolean foundSymbols, String name, AccessModifier modifier, Predicate predicate){
